...
class AdvertisersLoginScreen extends StatefulWidget {
  const AdvertisersLoginScreen({super.key});
  @override
  State<AdvertisersLoginScreen> createState() => _AdvertisersLoginScreenState();
}

class _AdvertisersLoginScreenState extends State<AdvertisersLoginScreen>
  ...
  Widget _creds() => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    Text('Advertisers', style: TextStyle(fontFamily: 'Georgia', fontSize: 26, fontWeight: FontWeight.bold, color: AppColors.textPrimary, height: 1.2)),
    const SizedBox(height: 4),
    Text('Portal de publicidad', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)),
    ...
    Center(child: GestureDetector(onTap: () => context.go('/register'),
      child: Text('¿Primera vez? Registrarse', style: TextStyle(fontSize: 13, color: AppColors.textSecondary)))),
  ]);
  ...
  Widget _enterEmail() => Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    AppTextField(controller: _recoverEmailCtrl, hint: 'correo@empresa.com', icon: Icons.mail_outline_rounded, keyboardType: TextInputType.emailAddress),
