  ...
  Future<void> _load() async {
    try {
      ...
      final tenant = await db
          .from('tenants')
          .select('id, business_name, slug, owner_id, primary_color, logo_url')
    ...
    if (success) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: const Row(children: [
          ...
          SizedBox(width: 8),
          Expanded(child: Text('¡Pedido realizado! El negocio lo revisará pronto.', style: TextStyle(fontWeight: FontWeight.w600))),
        ]),
              ...
              child: Center(
                child: ConstrainedBox(
                  ...
                  SliverAppBar(
                    ...
                    floating: false,
                    pinned: true,
                    backgroundColor: AppColors.surface.withValues(alpha: 0.95), // Efecto translúcido al hacer scroll
                            ...
                            if (_logoUrl != null) ...[
                              Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.network(_logoUrl!, width: 44, height: 44, fit: BoxFit.cover,
                              ...
                              Row(children: [
                                Container(
                                  ...
                                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                                    ...
                                    Text('${widget.tenantSlug}.quinindews.com', style: const TextStyle(fontSize: 11, color: Colors.white70)),
                                  ]),
                                ),
                              ]),
                            ])),
                    ...
                    title: Row(mainAxisSize: MainAxisSize.min, children: [
                      if (_logoUrl != null) ...[
                        ClipRRect(
                          ...
                          child: Image.network(_logoUrl!, width: 22, height: 22, fit: BoxFit.cover,
                            errorBuilder: (_, __, ___) => const SizedBox.shrink()),
                        ),
                        const SizedBox(width: 8),
                      ],
                      Flexible(child: Text(businessName, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.textPrimary), overflow: TextOverflow.ellipsis)),
                    ]),
                  ),
...
// ─────────────────────────────────────────────
// Inline Product Detail (Prioridad 2)
// ─────────────────────────────────────────────
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\$${price.toStringAsFixed(2)}', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: widget.primaryColor)),
...
// ─────────────────────────────────────────────
// Carrito BottomSheet rediseñado
// ─────────────────────────────────────────────
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text('\$${widget.cartTotal.toStringAsFixed(2)}', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: widget.primaryColor)),
                ]),
                const SizedBox(height: 16),
                SizedBox(
                  width: double.infinity,
